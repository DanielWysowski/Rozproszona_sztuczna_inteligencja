...
public class BookTradingOntology extends Ontology implements BookTradingVocabulary {
    ...
    /** As explained in section 5.1.3.6 pag. 90, it is suggested to move
     * all the following constants, which represent the Vocabulary of the ontology,
     * into the BookTradingVocabulary interface
     // VOCABULARY
